...
CREATE INDEX IF NOT EXISTS idx_registrations_cookie_id ON registrations(cookie_id);
...
-- INSERT INTO registrations (name, drinks, individual_wishes, cookie_id) VALUES
